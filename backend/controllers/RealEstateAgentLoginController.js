...
const RealEstateAgentAccount = require("../entities/RealEstateAgentAccount.js");

class RealEstateAgentLoginController {
    login = async (req, res, next) => {
        ...
        try {
            ...
            const account = await new RealEstateAgentAccount().getAccount(email);
...
module.exports = RealEstateAgentLoginController;
