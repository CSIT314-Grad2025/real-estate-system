...
const SystemAdminAccount = require("../entities/SystemAdminAccount.js");

class SystemAdminLoginController {
    login = async (req, res, next) => {
        ...
        try {
            ...
            const account = await new SystemAdminAccount().getAccount(email);
...
module.exports = SystemAdminLoginController;
