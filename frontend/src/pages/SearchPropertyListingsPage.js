...
class SearchPropertyListingsPage extends Component {
    state;
    ...
    handleChange = (e) => {
        ...
        this.setState({
            filteredPropertyListings: this.state.userProfiles.filter((userProfile, idx) =>
    ...
    fetchPropertyListings = async () => {
        try {
            ...
            this.setState({
                ...
                filteredPropertyListings: [...response?.data].sort((a, b) => a.id - b.id),
            })
        } catch (err) {
            ...
            >
                ...
                <div>
                    ...
                    <Paper variant='outlined' sx={{ marginTop: 10, maxWidth: '50%', mx: 'auto', }}>
                        ...
                        {this.state.filteredPropertyListings.map((userProfile, idx) => (
                            <Row key={userProfile.id} handleClick={this.handleClick} userProfile={userProfile} />
                        ))}
                    </Paper>
                    {this.state.filteredPropertyListings.length === 0 &&
...
export default withRouter(SearchPropertyListingsPage);
