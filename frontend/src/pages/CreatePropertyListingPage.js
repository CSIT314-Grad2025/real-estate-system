...
class CreatePropertyListingPage extends Component {
    state;
    ...
    handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`/realestateagent/create/listing`, payload, {
                headers: {
    ...
    render() {
        return (
            ...
            >
                ...
                <CssBaseline />
                <div>
                    <AppHeader title="New Property Listing" />
...
export default withRouter(CreatePropertyListingPage);
